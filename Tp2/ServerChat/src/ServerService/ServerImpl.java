...
public class ServerImpl extends UnicastRemoteObject implements ServerInterface {
    ...
    public void sendMessage(Message message) throws RemoteException, MalformedURLException, NotBoundException {
        ...
        try{
            ...
            System.out.println("Notification not Sent. [User Not Connected to Server]");
    ...
    public List<Message> returnMessageToUser(String userPhoneNumber) throws RemoteException {
        ...
        for(ArrayList<Message> messageArrayList :msg.values()){
            for (Message message:messageArrayList){
                if(message.getReceiver().getPhoneNum()==userPhoneNumber && !message.isStatus()){
